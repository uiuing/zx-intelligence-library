package com.example.wisdombooks.filter;
...
public class LoginCheckFilter implements Filter {
    ...
    public void doFilter(ServletRequest servletRequest, ServletResponse servletResponse, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (request.getSession().getAttribute("idCard") != null) {
            log.info("用户已登录,用户id为:{}", request.getSession().getAttribute("idCard"));

            String empId = (String) request.getSession().getAttribute("idCard");
